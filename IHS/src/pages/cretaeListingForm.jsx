    ...
    const handleopen = async (event) => {
        ...
        if (
           ...
           // console.log(enterance)
            ...
            toast.success('Upload Data Succefully', {
                position: "bottom-center",
                autoClose: 5000,
                hideProgressBar: false,
                closeOnClick: true,
                                ...
                                <form onSubmit={(e) => handleopen(e)} className="space-y-6">
                                    <div className="space-y-6 p-4 rounded border bg-gray-50">
                                        ...
                                        <div className="grid grid-cols-1 gap-5">
                                            <div className="space-y-1 grow">
                                                <label htmlFor="Dimensions" className="font-medium">Sq-Yard (Area):</label>
                                                <input

                                                    value={length}
                                                    onChange={(e) => setlength(e.target.value)}

                                                    className="block border placeholder-gray-400 px-5 py-3 leading-6 w-full rounded border-gray-200 focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" type="number" id="dimensionlength" name="dimensionlength" placeholder="Sq-Yard (Area)" />
                                            </div>
