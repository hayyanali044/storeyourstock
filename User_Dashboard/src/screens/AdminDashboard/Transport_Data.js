...
const Transf_Service = () => {
    ...
    const getData = () => {
        var data = ref(database, "Transf_Service")
    ...
    const CreateCategory = () => {
        ...
        const handlerSUbmit = async () => {
            ...
            let dbref = ref(database, `Category`)
            ...
            try {
                let dbref = ref(database, `Category/${key}`); //ref,path
                await set(dbref, obj);
            ...
            <div className="w-[60%] ml-4 bg-cardColor px-4 py-4 rounded-xl" >
                <div className="w-full  flex flex-col">
                    <div className="flex justify-between py-2 px-2 items-center">
                        <h1 className="text-xl font-bold text-mainTextColor font-[SF-Pro-Display-Regular]">Add Categories </h1>
                    ...
                    <div className="flex gap-4 my-2 ">
                        <div className="px-2 w-full rounded bg-background">
                            <input type="text"
                                ...
                                className='placeholder:text-white bg-background outline-none   py-2 my-2 px-2  text rounded-md  w-full mt-'
    ...
    const deleteData =async (key) => {
        ...
        console.log("jbfbhj")
        try{
            const dataRef = ref(database, `Category/${key}`);
                ...
                {selected ? <div className="w-full h-full flex gap-4 ">
                    ...
                    <div className="">
                        <div className="flex mb-6 justify-between my-4 mr-4">
                            <div className="px-4 ">
                                <h1 className={`border-b border-t-0 border-x-0 border-4 border-white inline ${theme == 'light' ? 'text-[#82b012] border-[#82b012]' : 'border-white text-white'} text-5xl font-bold font-[SF-Pro-Display-Regular] tracking-wide`}>Transport Services</h1>
                            </div>
