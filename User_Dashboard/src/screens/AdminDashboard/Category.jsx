...
const Categories = () => {
    ...
    const getData = () => {
        var data = ref(database, "Category")
                ...
                {selected ? <div className="w-full h-full flex gap-4 ">
                    ...
                    <div className="">
                        <div className="flex mb-6 justify-between my-4 mr-4">
                            <div className="px-4 ">
                                <h1 className={`border-b border-t-0 border-x-0 border-4 border-white inline ${theme == 'light' ? 'text-[#82b012] border-[#82b012]' : 'border-white text-white'} text-5xl font-bold font-[SF-Pro-Display-Regular] tracking-wide`}>Categories List</h1>
                            </div>
