...
import { faStore, faChartLine, faTruckFast, faCartShopping, faBookmark, faUser, faArrowsSplitUpAndLeft, faUserSlash, faCartPlus, faCity, faOutdent } from '@fortawesome/free-solid-svg-icons'
